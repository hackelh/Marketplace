                ...
                <div class="md:flex">
                    ...
                    <div class="md:w-1/2 p-4">
                        ...
                        <div class="flex items-center mb-4">
                            <span class="text-2xl font-semibold text-indigo-600">{{ \App\Helpers\PriceHelper::convertAndFormat($product->prix) }}</span>
                        ...
                        @if($product->quantite > 0)
                            <button wire:click="addToCart({{ $product->id }})"
                                    class="w-full bg-indigo-600 text-white py-3 px-6 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Ajouter au panier
                            </button>
                        @else
